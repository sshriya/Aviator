...
#Publish 2 messages for notifying whether tag found and also the position of the tag
...
class tagDetect:
	def __init__( self ):
		...
		self.pub_tag_pose = rospy.Publisher('/gBot/tagPose', Vector3)
		self.pub_tag_flag = rospy.Publisher('/gBot/tagFlag', Bool)
		self.msg1 = Vector3()
		self.msg2 = Bool()
...
def detect():
	...
	rospy.init_node('gtagdetect', anonymous=True)
